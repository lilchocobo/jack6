...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full grid grid-rows-[1fr_auto] gap-1 p-2 border-4 border-blue-500 bg-green-100">
        {/* Main Content Row */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 w-full h-full min-h-0 border-4 border-purple-500 bg-pink-100">
          ...
          style={{ backgroundColor: "black", borderColor: "blue", borderWidth: 4, borderRadius: "0.5rem", zIndex: 1 }}
          id="CENTER"
          >
            <CenterColumn
